...
export class IngredientService {
  ...
  createIngredient(ingredient: ingredient): Observable<any> {
    ...
    return this.http.post<ingredient>(`${this.apiUrl}/Ingredients/CreateIngredient`, ingredient)
  }

  updateIngredient(id: number, ingredient: ingredient): Observable<any> {

    return this.http.put<ingredient>(`${this.apiUrl}/Ingredients/UpdateIngredient/${id}`, ingredient);
  }
